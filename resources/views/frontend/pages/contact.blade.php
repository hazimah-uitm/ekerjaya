...
@section('content')
    ...
    <div class="container-fliud py-5">
        <div class="container">
            <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Hubungi For Any Query</h1>
            <div class="row g-4">
                <div class="col-12">
                    <div class="row gy-4">
                ...
                <div class="col-md-6">
                    <div class="wow fadeInUp" data-wow-delay="0.5s">
                        <h4 class="mb-4">Receive messages instantly with our PHP and Ajax contact form - available in the
                            <a href="https://htmlcodex.com/downloading/?item=2246">Pro Version</a> only.</h4>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" class="form-control" id="email" placeholder="Emel Anda">
