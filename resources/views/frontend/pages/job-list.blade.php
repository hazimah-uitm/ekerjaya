...
@section('content')
    ...
    <div class="container-fluid py-5 bg-dark page-header mb-5">
        <div class="container my-5 pt-5 pb-4">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Jawatan Kosong</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb text-uppercase">
                    <li class="breadcrumb-item"><a href="#">Utama</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Jawatan Kosong</li>
                </ol>
            </nav>
        </div>
    </div>
